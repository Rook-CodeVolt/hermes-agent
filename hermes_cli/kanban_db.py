...
def promote_task(
    ...
    # first claim silently reverts (#106195). Check the complete ancestor graph,
    # and use typed acceptance outcomes: archived or negatively-completed work
    # never satisfies a dependency. The dependency itself is the knob.
