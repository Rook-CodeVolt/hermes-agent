...
_LATER_TASK_COLUMNS = (
    ...
    # Semantic verdict is independent from lifecycle state. NULL is a legacy
    # accepted completion and is interpreted as ``completed`` by the domain.
    ("completion_outcome", "completion_outcome TEXT"),
